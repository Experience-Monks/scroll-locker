var scrollLock = require('../index.js');
var isContScrollDisabled;
...
button.onclick = setContLockState;

container.appendChild(button);
document.body.appendChild(container);

var scroll = scrollLock(container);
setContLockState();

function setContLockState() {
  isContScrollDisabled = !isContScrollDisabled;
  if (isContScrollDisabled) {
    scroll.lock();
    button.innerHTML = 'enable container scroll';
    button.style.color = 'red';
  } else {
    scroll.unlock();
    button.innerHTML = 'disable container scroll';
